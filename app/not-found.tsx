    ...
    <div className="min-h-screen bg-bg-primary flex flex-col items-center justify-center px-6 text-center">
      <div className="flex flex-col items-center gap-8 max-w-lg">
        ...
        <div className="relative">
          <span className="font-syne font-black text-[120px] md:text-[160px] leading-none opacity-5 select-none">
            404
          </span>
        ...
        <div className="flex flex-col gap-4 mt-[-20px]">
          <h2 className="font-syne font-bold text-3xl text-txt-primary uppercase tracking-tight">
        ...
        <Link
          href="/"
          className="bg-accent text-bg-primary font-syne font-bold text-xs tracking-widest uppercase px-12 py-5 rounded-button shadow-[0_20px_40px_rgba(207,174,58,0.2)] hover:shadow-[0_25px_50px_rgba(207,174,58,0.3)] hover:-translate-y-1 transition-all duration-300"
        >
          REGRESAR AL NÚCLEO
        </Link>
      </div>
